...
add wave -noupdate -color Gray60 -label Core2Id /coretestprotocol/X1/ArkI2/CoreId
...
add wave -noupdate -color {Olive Drab} -label CoreWrData -radix hexadecimal /coretestprotocol/X1/ArkI2/AddressSolver/CoreWrData
add wave -noupdate -color {Olive Drab} -label CoreDataAddress -radix hexadecimal /coretestprotocol/X1/ArkI2/AddressSolver/CoreDataAddress
add wave -noupdate -color {Olive Drab} -label CoreRdWrEnable /coretestprotocol/X1/ArkI2/AddressSolver/CoreRdWrEna
add wave -noupdate -color {Olive Drab} -label CacheRdData -radix hexadecimal /coretestprotocol/X1/ArkI2/AddressSolver/CacheRdData
add wave -noupdate -color {Olive Drab} -label CoreRdData -radix hexadecimal /coretestprotocol/X1/ArkI2/AddressSolver/CoreRdData
add wave -noupdate -color {Olive Drab} -label CacheWrData -radix hexadecimal /coretestprotocol/X1/ArkI2/AddressSolver/CacheWrData
add wave -noupdate -color {Olive Drab} -label CacheDataAddress -radix hexadecimal /coretestprotocol/X1/ArkI2/AddressSolver/CacheDataAddress
add wave -noupdate -color {Olive Drab} -label CacheRdWrEnable /coretestprotocol/X1/ArkI2/AddressSolver/CacheRdWrEna
...
add wave -noupdate -color {Cornflower Blue} -label Instruction -radix hexadecimal /coretestprotocol/X1/ArkI2/ArkI/DS/Instruction
...
add wave -noupdate -color {Slate Blue} -label GprData1 -radix hexadecimal /coretestprotocol/X1/ArkI2/ArkI/AS/RegisterData.GprData1
add wave -noupdate -color {Slate Blue} -label GprData2 -radix hexadecimal /coretestprotocol/X1/ArkI2/ArkI/AS/RegisterData.GprData2
add wave -noupdate -color {Slate Blue} -label ImmData -radix hexadecimal /coretestprotocol/X1/ArkI2/ArkI/AS/RegisterData.ImmData
add wave -noupdate -color {Slate Blue} -label CsrImmData -radix hexadecimal /coretestprotocol/X1/ArkI2/ArkI/AS/RegisterData.CsrImmData
add wave -noupdate -color {Slate Blue} -label Shamt -radix hexadecimal /coretestprotocol/X1/ArkI2/ArkI/AS/RegisterData.Shamt
add wave -noupdate -color {Slate Blue} -label Pc -radix hexadecimal /coretestprotocol/X1/ArkI2/ArkI/AS/RegisterData.Pc
...
add wave -noupdate -color Sienna -label AluResult -radix hexadecimal /coretestprotocol/X1/ArkI2/ArkI/WBS/MemoryData.AluResult
add wave -noupdate -color Sienna -label MemData -radix hexadecimal /coretestprotocol/X1/ArkI2/ArkI/WBS/MemoryData.MemData
add wave -noupdate -color Sienna -label ImmData -radix hexadecimal /coretestprotocol/X1/ArkI2/ArkI/WBS/MemoryData.ImmData
add wave -noupdate -color Sienna -label RdAddress -radix hexadecimal /coretestprotocol/X1/ArkI2/ArkI/WBS/MemoryData.RdAddress
add wave -noupdate -color Sienna -label CsrData -radix hexadecimal /coretestprotocol/X1/ArkI2/ArkI/WBS/MemoryData.CsrData
add wave -noupdate -color Sienna -label Negative /coretestprotocol/X1/ArkI2/ArkI/WBS/MemoryData.Negative
add wave -noupdate -color Sienna -label PcNext -radix hexadecimal /coretestprotocol/X1/ArkI2/ArkI/WBS/MemoryData.PcNext
...
add wave -noupdate -color {Medium Orchid} -label CtrlWord /coretestprotocol/X1/ArkI2/ArkI/Ctrl/ControlWord
add wave -noupdate -color {Medium Orchid} -label ExcCtrlWord /coretestprotocol/X1/ArkI2/ArkI/Ctrl/ExcCtrlWord
add wave -noupdate -color {Medium Orchid} -label BranchType /coretestprotocol/X1/ArkI2/ArkI/Ctrl/BranchType
add wave -noupdate -color {Medium Orchid} -label BpuMode /coretestprotocol/X1/ArkI2/ArkI/Ctrl/BpuMode
add wave -noupdate -color {Medium Orchid} -label GprRsX1 /coretestprotocol/X1/ArkI2/ArkI/Ctrl/GprAddress
add wave -noupdate -color {Medium Orchid} -label DfuMode /coretestprotocol/X1/ArkI2/ArkI/Ctrl/DfuMode
add wave -noupdate -color {Medium Orchid} -label PipelineMode /coretestprotocol/X1/ArkI2/ArkI/Ctrl/PipelineMode
add wave -noupdate -divider Ctrl-FSM
add wave -noupdate -color {Blue Violet} -label MNEV -radix hexadecimal /coretestprotocol/X1/ArkI2/ArkI/Ctrl/CtrlFsm/MNEV
add wave -noupdate -color {Blue Violet} -label Mie -radix hexadecimal /coretestprotocol/X1/ArkI2/ArkI/Ctrl/CtrlFsm/Mie
add wave -noupdate -color {Blue Violet} -label Mps -radix hexadecimal /coretestprotocol/X1/ArkI2/ArkI/Ctrl/CtrlFsm/Mps
add wave -noupdate -color {Blue Violet} -label PcMode /coretestprotocol/X1/ArkI2/ArkI/Ctrl/CtrlFsm/PcMode
add wave -noupdate -color {Blue Violet} -label CycleMePc /coretestprotocol/X1/ArkI2/ArkI/Ctrl/CtrlFsm/CycleMePc
add wave -noupdate -color {Blue Violet} -label CsrExcWrEna /coretestprotocol/X1/ArkI2/ArkI/Ctrl/CtrlFsm/CsrExcWrEna
add wave -noupdate -color {Blue Violet} -label ExcCsrWrAddress -radix hexadecimal /coretestprotocol/X1/ArkI2/ArkI/Ctrl/CtrlFsm/ExcCsrWrAddress
add wave -noupdate -color {Blue Violet} -label ExcCsrData -radix hexadecimal /coretestprotocol/X1/ArkI2/ArkI/Ctrl/CtrlFsm/ExcCsrData
add wave -noupdate -color {Blue Violet} -label ExcMemRd /coretestprotocol/X1/ArkI2/ArkI/Ctrl/CtrlFsm/ExcMemRd
add wave -noupdate -color {Blue Violet} -label AluExcOp /coretestprotocol/X1/ArkI2/ArkI/Ctrl/CtrlFsm/AluExcOp
add wave -noupdate -color {Blue Violet} -label ExcPcWrEna /coretestprotocol/X1/ArkI2/ArkI/Ctrl/CtrlFsm/ExcPcWrEna
...
add wave -noupdate -color Salmon -label ImmData -radix hexadecimal /coretestprotocol/X1/ArkI2/ArkI/DS/PCR/ImmData
add wave -noupdate -color Salmon -label NewPc -radix hexadecimal /coretestprotocol/X1/ArkI2/ArkI/DS/PCR/NewPc
add wave -noupdate -color Salmon -label MepcRd -radix hexadecimal /coretestprotocol/X1/ArkI2/ArkI/DS/PCR/MepcRd
add wave -noupdate -color Salmon -label EnaLoad /coretestprotocol/X1/ArkI2/ArkI/DS/PCR/EnaLoad
add wave -noupdate -color Salmon -label EnaLoadMS /coretestprotocol/X1/ArkI2/ArkI/DS/PCR/EnaLoadMS
add wave -noupdate -color Salmon -label AluResult -radix hexadecimal /coretestprotocol/X1/ArkI2/ArkI/DS/PCR/AluResult
add wave -noupdate -color Salmon -label NewExcPc -radix hexadecimal /coretestprotocol/X1/ArkI2/ArkI/DS/PCR/NewExcPc
add wave -noupdate -color Salmon -label PcMode /coretestprotocol/X1/ArkI2/ArkI/DS/PCR/PcMode
add wave -noupdate -color Salmon -label ExcPcWrEna /coretestprotocol/X1/ArkI2/ArkI/DS/PCR/ExcPcWrEna

...
add wave -noupdate -color Blue -label DataDependency /coretestprotocol/X1/ArkI1/ArkI/DFU/DataDependency
add wave -noupdate -group DependencySignals -color Blue -label Rs1DepDsToRs /coretestprotocol/X1/ArkI1/ArkI/DFU/Rs1DepDsToRs
add wave -noupdate -group DependencySignals -color Blue -label Rs2DepDsToRs /coretestprotocol/X1/ArkI1/ArkI/DFU/Rs2DepDsToRs
add wave -noupdate -group DependencySignals -color Blue -label Rs1DepDsToAs /coretestprotocol/X1/ArkI1/ArkI/DFU/Rs1DepDsToAs
add wave -noupdate -group DependencySignals -color Blue -label Rs2DepDsToAs /coretestprotocol/X1/ArkI1/ArkI/DFU/Rs2DepDsToAs
add wave -noupdate -group DependencySignals -color Blue -label Rs1DepRsToAs /coretestprotocol/X1/ArkI1/ArkI/DFU/Rs1DepRsToAs
add wave -noupdate -group DependencySignals -color Blue -label Rs2DepRsToAs /coretestprotocol/X1/ArkI1/ArkI/DFU/Rs2DepRsToAs
add wave -noupdate -group DependencySignals -color Blue -label DsDependency /coretestprotocol/X1/ArkI1/ArkI/DFU/DsDependency
add wave -noupdate -group DependencySignals -color Blue -label RsDependency /coretestprotocol/X1/ArkI1/ArkI/DFU/RsDependency
add wave -noupdate -group DependencySignals -color Blue -label NextDep /coretestprotocol/X1/ArkI1/ArkI/DFU/NextDependency
add wave -noupdate -group DependencySignals -color Blue -label PrevDep /coretestprotocol/X1/ArkI1/ArkI/DFU/PrevDependency
add wave -noupdate -group {In DS} -color Blue -label Pc -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/DFU/GprAddress.Pc
add wave -noupdate -group {In DS} -color Blue -label Rs1 -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/DFU/GprAddress.Rs1
add wave -noupdate -group {In DS} -color Blue -label Rs2 -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/DFU/GprAddress.Rs2
add wave -noupdate -group {In DS} -color Blue -label Rd -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/DFU/GprAddress.Rd
add wave -noupdate -group {Reg RS} -color Blue -label Pc -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/DFU/PrevReg.RS.Pc
add wave -noupdate -group {Reg RS} -color Blue -label Rs1 -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/DFU/PrevReg.RS.Rs1
add wave -noupdate -group {Reg RS} -color Blue -label Rs2 -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/DFU/PrevReg.RS.Rs2
add wave -noupdate -group {Reg RS} -color Blue -label Rd -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/DFU/PrevReg.RS.Rd
add wave -noupdate -group {Reg AS} -color Blue -label Pc -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/DFU/PrevReg.AS.Pc
add wave -noupdate -group {Reg AS} -color Blue -label Rs1 -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/DFU/PrevReg.AS.Rs1
add wave -noupdate -group {Reg AS} -color Blue -label Rs2 -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/DFU/PrevReg.AS.Rs2
add wave -noupdate -group {Reg AS} -color Blue -label Rd -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/DFU/PrevReg.AS.Rd
add wave -noupdate -group {Reg MS} -color Blue -label Pc -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/DFU/PrevReg.MS.Pc
add wave -noupdate -group {Reg MS} -color Blue -label Rs1 -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/DFU/PrevReg.MS.Rs1
add wave -noupdate -group {Reg MS} -color Blue -label Rs2 -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/DFU/PrevReg.MS.Rs2
add wave -noupdate -group {Reg MS} -color Blue -label Rd -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/DFU/PrevReg.MS.Rd
add wave -noupdate -group DfuDataOut -color Blue -label DfuWrEna -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/DFU/DfuDataOut.DfuWrEna
add wave -noupdate -group DfuDataOut -color Blue -label DfuAddress -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/DFU/DfuDataOut.DfuAddress
add wave -noupdate -group DfuDataOut -color Blue -label DfuData -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/DFU/DfuDataOut.DfuData
...
WaveRestoreCursors {{Cursor 1} {11460 ns} 0}

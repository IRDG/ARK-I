...
add wave -noupdate -color Gray60 -label Irq /coretestprotocol/X1/ArkI1/ArkI/IRQ
add wave -noupdate -color Gray60 -label Ack /coretestprotocol/X1/ArkI1/ArkI/Ack
...
add wave -noupdate -group AluInput -color {Slate Blue} -label GprData1 -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/AS/RegisterData.GprData1
add wave -noupdate -group AluInput -color {Slate Blue} -label GprData2 -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/AS/RegisterData.GprData2
add wave -noupdate -group AluInput -color {Slate Blue} -label ImmData -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/AS/RegisterData.ImmData
add wave -noupdate -group AluInput -color {Slate Blue} -label CsrImmData -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/AS/RegisterData.CsrImmData
add wave -noupdate -group AluInput -color {Slate Blue} -label Shamt -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/AS/RegisterData.Shamt
add wave -noupdate -group AluInput -color {Slate Blue} -label Pc -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/AS/RegisterData.Pc
...
add wave -noupdate -group WriteBackInput -color Sienna -label AluResult -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/WBS/MemoryData.AluResult
add wave -noupdate -group WriteBackInput -color Sienna -label MemData -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/WBS/MemoryData.MemData
add wave -noupdate -group WriteBackInput -color Sienna -label ImmData -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/WBS/MemoryData.ImmData
add wave -noupdate -group WriteBackInput -color Sienna -label RdAddress -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/WBS/MemoryData.RdAddress
add wave -noupdate -group WriteBackInput -color Sienna -label CsrData -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/WBS/MemoryData.CsrData
add wave -noupdate -group WriteBackInput -color Sienna -label Negative /coretestprotocol/X1/ArkI1/ArkI/WBS/MemoryData.Negative
add wave -noupdate -group WriteBackInput -color Sienna -label PcNext -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/WBS/MemoryData.PcNext
...
add wave -noupdate -color {Medium Orchid} -label CtrlWord -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/Ctrl/ControlWord
add wave -noupdate -color {Medium Orchid} -label ExcCtrlWord -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/Ctrl/ExcCtrlWord
add wave -noupdate -group OtherCtrlSignals -color {Medium Orchid} -label BranchType /coretestprotocol/X1/ArkI1/ArkI/Ctrl/BranchType
add wave -noupdate -group OtherCtrlSignals -color {Medium Orchid} -label BpuMode /coretestprotocol/X1/ArkI1/ArkI/Ctrl/BpuMode
add wave -noupdate -group OtherCtrlSignals -color {Medium Orchid} -label GprAddress -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/Ctrl/GprAddress
add wave -noupdate -group OtherCtrlSignals -color {Medium Orchid} -label DfuMode /coretestprotocol/X1/ArkI1/ArkI/Ctrl/DfuMode
add wave -noupdate -group OtherCtrlSignals -color {Medium Orchid} -label PipelineMode /coretestprotocol/X1/ArkI1/ArkI/Ctrl/PipelineMode
...
add wave -noupdate -group CtrlFsmSignals -color {Blue Violet} -label MNEV -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/Ctrl/CtrlFsm/MNEV
add wave -noupdate -group CtrlFsmSignals -color {Blue Violet} -label Mie -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/Ctrl/CtrlFsm/Mie
add wave -noupdate -group CtrlFsmSignals -color {Blue Violet} -label Mps -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/Ctrl/CtrlFsm/Mps
add wave -noupdate -group CtrlFsmSignals -color {Blue Violet} -label PcMode /coretestprotocol/X1/ArkI1/ArkI/Ctrl/CtrlFsm/PcMode
add wave -noupdate -group CtrlFsmSignals -color {Blue Violet} -label CycleMePc /coretestprotocol/X1/ArkI1/ArkI/Ctrl/CtrlFsm/CycleMePc
add wave -noupdate -group CtrlFsmSignals -color {Blue Violet} -label CsrExcWrEna /coretestprotocol/X1/ArkI1/ArkI/Ctrl/CtrlFsm/CsrExcWrEna
add wave -noupdate -group CtrlFsmSignals -color {Blue Violet} -label ExcCsrWrAddress -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/Ctrl/CtrlFsm/ExcCsrWrAddress
add wave -noupdate -group CtrlFsmSignals -color {Blue Violet} -label ExcCsrData -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/Ctrl/CtrlFsm/ExcCsrData
add wave -noupdate -group CtrlFsmSignals -color {Blue Violet} -label ExcMemRd /coretestprotocol/X1/ArkI1/ArkI/Ctrl/CtrlFsm/ExcMemRd
add wave -noupdate -group CtrlFsmSignals -color {Blue Violet} -label AluExcOp /coretestprotocol/X1/ArkI1/ArkI/Ctrl/CtrlFsm/AluExcOp
add wave -noupdate -group CtrlFsmSignals -color {Blue Violet} -label ExcPcWrEna /coretestprotocol/X1/ArkI1/ArkI/Ctrl/CtrlFsm/ExcPcWrEna
...
add wave -noupdate -group PcSignals -color Salmon -label ImmData -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/DS/PCR/ImmData
add wave -noupdate -group PcSignals -color Salmon -label NewPc -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/DS/PCR/NewPc
add wave -noupdate -group PcSignals -color Salmon -label MepcRd -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/DS/PCR/MepcRd
add wave -noupdate -group PcSignals -color Salmon -label EnaLoad /coretestprotocol/X1/ArkI1/ArkI/DS/PCR/EnaLoad
add wave -noupdate -group PcSignals -color Salmon -label EnaLoadMS /coretestprotocol/X1/ArkI1/ArkI/DS/PCR/EnaLoadMS
add wave -noupdate -group PcSignals -color Salmon -label AluResult -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/DS/PCR/AluResult
add wave -noupdate -group PcSignals -color Salmon -label NewExcPc -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/DS/PCR/NewExcPc
add wave -noupdate -group PcSignals -color Salmon -label PcMode /coretestprotocol/X1/ArkI1/ArkI/DS/PCR/PcMode
add wave -noupdate -group PcSignals -color Salmon -label ExcPcWrEna /coretestprotocol/X1/ArkI1/ArkI/DS/PCR/ExcPcWrEna

...
add wave -noupdate -color {Blue Violet} -label MipRd -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/Ctrl/CtrlFsm/MipRd
add wave -noupdate -color {Blue Violet} -label MipWr -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/Ctrl/CtrlFsm/MipWr
add wave -noupdate -color {Blue Violet} -label ExcMipWrEna /coretestprotocol/X1/ArkI1/ArkI/Ctrl/CtrlFsm/ExcMipWrEna
add wave -noupdate -color {Blue Violet} -label Exception -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/Ctrl/CtrlFsm/Exception
add wave -noupdate -color {Blue Violet} -label Cause -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/Ctrl/CtrlFsm/Cause
...
add wave -noupdate -divider Exc-Signals
add wave -noupdate -color Goldenrod -label AluResult -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/AS/ALU/AluResult
add wave -noupdate -color Goldenrod -label ExcOp -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/AS/ALU/ExcOp
add wave -noupdate -color Goldenrod -label PrevTempCause -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/Ctrl/CtrlFsm/Cause
add wave -noupdate -color Goldenrod -label CausePriority -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/Ctrl/CtrlFsm/CausePriority
add wave -noupdate -color Goldenrod -label CurrentPriority -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/Ctrl/CtrlFsm/CurrentPriority
add wave -noupdate -color Goldenrod -label MnevLevel -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/Ctrl/CtrlFsm/MnevLevel
add wave -noupdate -group PriorityRegisters -color Goldenrod -label Priority0 -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/Ctrl/CtrlFsm/PrevPriority0
add wave -noupdate -group PriorityRegisters -color Goldenrod -label Priority1 -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/Ctrl/CtrlFsm/PrevPriority1
add wave -noupdate -group PriorityRegisters -color Goldenrod -label Priority2 -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/Ctrl/CtrlFsm/PrevPriority2
add wave -noupdate -group PriorityRegisters -color Goldenrod -label Priority3 -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/Ctrl/CtrlFsm/PrevPriority3
add wave -noupdate -color Goldenrod -label NextMePc0 -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/RRS/CSR/NextMepc0
add wave -noupdate -color Goldenrod -label NextMePc1 -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/RRS/CSR/NextMepc1
add wave -noupdate -color Goldenrod -label NextMePc2 -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/RRS/CSR/NextMepc2
add wave -noupdate -color Goldenrod -label NextMePc3 -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/RRS/CSR/NextMepc3
add wave -noupdate -color Goldenrod -label CycleMepc -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/RRS/CSR/CycleMepc
add wave -noupdate -color Goldenrod -label Mepc0Enable -radix hexadecimal /coretestprotocol/X1/ArkI1/ArkI/RRS/CSR/Mepc0Enable
